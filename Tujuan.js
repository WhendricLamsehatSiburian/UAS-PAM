    ...
    return (
        ...
        <View style={Style.body}>
            ...
            <View style={Style.body3}>
                <Text style={Style.Label1}>Pilih Pelabuhan </Text>
                </View>
                <View style={Style.body2}>
                    <Text style={Style.Label}>Banten</Text>
                    <Text style={Style.TextDewasa}>Merak</Text>
                    <Text style={Style.Label}>Jakarta</Text>
                    <Text style={Style.TextDewasa}>Tanjung Priok</Text>
                </View>
            <View style={Style.box}>
                <TouchableOpacity style={Style.tombol} onPress={tombol}>
